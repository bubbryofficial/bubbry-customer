...
export default function Home() {
  ...
  useEffect(() => {
    // Check if user is already logged in - if so skip landing page
  ...
  return (
    <main style={{
      ...
      <div style={{ position: "relative", textAlign: "center", maxWidth: 400 }}>
        ...
        <h1 style={{ fontSize: 52, fontWeight: 900, color: "white", letterSpacing: "-2px", lineHeight: 1, marginBottom: 8 }}>Bubbry</h1>
        <p style={{ fontSize: 16, color: "rgba(255,255,255,0.6)", fontWeight: 500, marginBottom: 32 }}>Your local shop, on your phone.</p>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          <a href="/login" className="hero-btn" style={{ background: "white", color: "#1A6BFF", boxShadow: "0 8px 30px rgba(0,0,0,0.2)" }}>Login</a>
          <a href="/signup" className="hero-btn" style={{ background: "rgba(255,255,255,0.12)", color: "white", border: "1.5px solid rgba(255,255,255,0.25)" }}>Create Account</a>
        </div>
      </div>
    </main>
  );
